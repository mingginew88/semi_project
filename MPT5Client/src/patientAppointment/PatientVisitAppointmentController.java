...
public class PatientVisitAppointmentController {
	...
	public static void setApptNum(int apptNum) {
		PatientVisitAppointmentController.apptNum = apptNum;
	}
    ...
    void appoint(ActionEvent event) throws ParseException {
    		...
    		ApptCheckController.setCheck(1);
    	try {
    ...
    @FXML
    void selectTime(MouseEvent event) throws RemoteException, ParseException {
    	String selectDate = "";
    	String selectTime="";
    ...
    void initialize() throws RemoteException {
        assert apptDate != null : "fx:id=\"apptDate\" was not injected: check your FXML file 'PatientVisitAppointment.fxml'.";
        assert deptList != null : "fx:id=\"deptList\" was not injected: check your FXML file 'PatientVisitAppointment.fxml'.";
        assert docList != null : "fx:id=\"docList\" was not injected: check your FXML file 'PatientVisitAppointment.fxml'.";
        assert timeList != null : "fx:id=\"timeList\" was not injected: check your FXML file 'PatientVisitAppointment.fxml'.";

        assert apptBtn != null : "fx:id=\"apptBtn\" was not injected: check your FXML file 'PatientVisitAppointment.fxml'.";
        //--------------------------------------------------------------------------------------------------------------------
        try {
